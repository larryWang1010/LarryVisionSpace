 ...
 * @Date: 2023-07-13 11:44:56
 * @LastEditors: jiajunwang 18035173529@163.com
 * @LastEditTime: 2023-07-13 14:32:23
 * @FilePath: /testOpencv/include/orb_slam2/ORBextractor.h
...
class ORBextractor {
   public:
    ...
    std::vector<cv::Mat> mvImagePyramid;  // vector 容器存储多层金字塔图像
