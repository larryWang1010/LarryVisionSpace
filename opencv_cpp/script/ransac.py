...
Date: 2023-07-13 16:44:28
LastEditors: jiajunwang 18035173529@163.com
LastEditTime: 2023-07-13 17:11:00
FilePath: /testOpencv/script/ransac.py
Description: RANSAC 曲线拟合
'''
import numpy as np
...
fig = plt.figure()
ax1 = fig.add_subplot(1, 1, 1) # 画图区域分成1行1列。选择第一块区域
ax1.set_title("RANSAC") # 标题
...
while i < iters:
    ...
    if total_inlier > SIZE:
        break
    i = i+1
# TODO 这里使用 for 循环有问题，暂时想不出来问题在哪
